...
7. **Write debrief**: `{workspace}/experiments/{name}/debrief.md` with:
   - Summary of what the experiment did
   - Key metrics (accuracy, F1, precision, recall) and how they compare to baselines
...
- If results look suspicious (impossibly high accuracy, etc.), flag it.
