...
"""
Potential data augmentations used in ICM2024 paper "Variational Schrödinger Diffusion Models" when training Forward-backward Schrodinger Bridge. 
Modified from EDM paper "Elucidating the Design Space of Diffusion-Based Generative Models"
