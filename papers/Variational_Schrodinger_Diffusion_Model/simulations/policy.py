...
def build(opt, dyn, direction):
    ...
    use_t_idx = (net_name in ['toy', 'LinearStatic', 'Linear', 'LinearImg', 'Unet', 'DGLSB']) # t_idx is handled internally in ncsnpp
...
def _build_net(opt, net_name):
    ...
    if net_name == 'toy':
        ...
        from models.toy_model.Linear import LinearPolicy
