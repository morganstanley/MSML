...
AVAILABLE_DATASETS = [
    'swissroll', 'circles', 'rings', 'moons', 'gaussian', '8gaussians',
    'pinwheel', 'spiral', '2spirals', 'checkerboard', 'line', 'cos',
]
...
def generate_data(
    ...
    if data == "swissroll":
        data = sklearn.datasets.make_swiss_roll(n_samples=n_samples, noise=0.5)[0]
