...
def set():
    ...
    default_config, model_configs = {
        ...
        # ICML paper.
        'exchange_rate_nips':           configs.get_exchange_rate_nips_default_configs,
        'solar_nips':           configs.get_solar_nips_default_configs,
        'electricity_nips': configs.get_electricity_nips_default_configs,
    }.get(problem_name)()
...
####################################################################################################
def get_default_args(problem_name):
    parser = _get_default_parser()
    ...
    default_config, model_configs = {
        ...
        'pm25':             configs.get_pm25_default_configs,
        'physio':           configs.get_physio_default_configs,
        # NIPS 2019 replication for ICML paper.
        'exchange_rate_nips': configs.get_exchange_rate_nips_default_configs,
        'solar_nips': configs.get_solar_nips_default_configs,
        'electricity_nips': configs.get_electricity_nips_default_configs,
    }.get(problem_name)()
