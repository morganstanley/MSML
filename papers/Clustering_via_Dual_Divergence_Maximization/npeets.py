...
# this module is here for estimating pairwise mutual information between time series, mostly adapted from https://github.com/gregversteeg/NPEET. Also, see the info below by the original coder.
