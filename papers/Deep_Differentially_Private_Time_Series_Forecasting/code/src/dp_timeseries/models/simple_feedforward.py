...
from gluonts.torch.model.simple_feedforward import (
    SimpleFeedForwardEstimator, SimpleFeedForwardLightningModule)
...
class DPSimpleFeedForwardLightningModule(SimpleFeedForwardLightningModule):
    """SimpleFeedForward with Noisy SGD Optimizer.
    """
    ...
    def __init__(
        ...
        Args:
            model_kwargs (dict): Arguments for model underlying the
                ...
                See gluonts.torch.model.simple_feedforward.module.SimpleFeedForwardModel.__init__.
...
class DPSimpleFeedForwardEstimator(DPPyTorchLightningEstimator, SimpleFeedForwardEstimator):
    ...
    def __init__(self,
        ...
        SimpleFeedForwardEstimator.__init__(self, **kwargs)
