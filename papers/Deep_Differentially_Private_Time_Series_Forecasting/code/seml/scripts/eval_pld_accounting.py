...
import numpy as np
import torch
from dp_timeseries.experiments.eval_pld_accounting import eval_pld_accounting
from numpy.typing import NDArray
from seml import Experiment

ex = Experiment()

eval_pld_accounting = ex.capture(eval_pld_accounting)
...
def run(_config: dict) -> dict:
    ...
    log_dir, results_dict = eval_pld_accounting(
        epsilons=epsilons,
