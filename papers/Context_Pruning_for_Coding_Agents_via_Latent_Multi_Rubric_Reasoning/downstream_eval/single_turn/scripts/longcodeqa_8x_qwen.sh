...
export PYTHONPATH=/path/to/swe-pruner:$PYTHONPATH
...
# Backbone / reranker model path.
# If you use the Qwen reranker, a common choice is "Qwen/Qwen3-Reranker-0.6B" (or a local path to it).
